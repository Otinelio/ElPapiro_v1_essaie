...
class ProduitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('staff.produit.index', compact('produit', 'total_produits', 'keyWord'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.produit.create', compact('categorie'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.produit.index')->with('success', 'Le produit a été créé avec succès !');
    }
    ...
    public function show(string $slug)
    {
        ...
        return view('staff.produit.show', compact('produit'));
    ...
    public function edit(string $slug)
    {
        ...
        $categorie = Categorie::all();
        $produit = Produit::where('slug', $slug)->firstOrFail();
        return view('staff.produit.edit', compact('produit', "categorie"));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $produit = Produit::findOrFail($id);
                ...
                return to_route('staff.produit.index')->with('message', "Produit modifié avec succès !");
    }
    ...
    public function destroy(string $id)
    {
        ...
        $produit->delete();
        return to_route('staff.produit.index')->with('message', "Produit supprimé avec succès !");
