        ...
        <div class="container">
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body px-4 py-4">
                    ...
                    @else
                        <form action="{{ route('staff.commande.valider.paiement.store', $commande) }}" method="POST">
                            @csrf
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="methode" id="methode" class="form-control"
                                        value="{{ $commande->mode_paiement }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="#{{ $commande->numero_commande ?? $commande->id }}" disabled>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ route('staff.commande.edit', $commande) }}" class="btn btn-outline-secondary">
                                    Annuler
                                </a>
                            </div>
                        </form>
