      ...
      <div class="card">
        <div class="card-header">
         ...
         <span class="card-title fs-3">Liste des produits</span> <span class="badge bg-primary">{{ $total_produits }}</span>
          <a href="{{ route('staff.produit.create') }}" class="btn btn-primary float-end">Ajouter un produit</a>
        </div>
        <div class="card-body">
          <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('staff.produit.show', $item->slug) }}" class="btn btn-info btn-sm">Voir</a>
                    <a href="{{ route('staff.produit.edit', $item->slug) }}" class="btn btn-warning btn-sm">Modifier</a>
                    <form action="{{ route('staff.produit.destroy', $item->id) }}" class="mt-2" method="POST">
                      @csrf
                      @method('DELETE')
