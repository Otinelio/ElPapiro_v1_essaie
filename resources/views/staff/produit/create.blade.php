    ...
    <section class="section dashboard-produits">
      <div class="row">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('staff.produit.store') }}" method="POST" class="row g-3 my-3" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6">
                    <label for="name" class="form-label  card-title py-0">Nom du produit</label>
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Entrer le nom du produit">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('sous_categorie') is-invalid @enderror" name="sous_categorie" id="sous_categorie">
                      <option selected hidden>Selectionner une sous-catégorie</option>
                        ...
                        <option value="{{ $categorie }}" {{ old('sous_categorie') == $categorie ? 'selected' : '' }}>{{ $categorie }}</option>
                        @endforeach
                  </select>
                </div>
                <div class="col-md-6">
                    <label for="prix" class="form-label  card-title py-0">Prix du produit</label>
                    <input type="number" name="prix" value="{{ old('prix') }}" class="form-control @error('prix') is-invalid @enderror" id="prix" placeholder="Entrer le prix du produit">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="quantite" value="{{ old('quantite') }}" class="form-control @error('quantite') is-invalid @enderror" id="quantite" placeholder="Entrer la quantité du produit">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="5" placeholder="Entrer la description du produit">{{ old('description') }}</textarea>
